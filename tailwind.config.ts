  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        void: "hsl(var(--void))",
        "void-deep": "hsl(var(--void-deep))",
        ice: "hsl(var(--ice))",
        flow: { DEFAULT: "hsl(var(--flow))", soft: "hsl(var(--flow-soft))" },
      ...
      keyframes: {
        ...
        "pulse-glow": { "0%, 100%": { boxShadow: "0 0 20px hsl(var(--flow) / 0.3)" }, "50%": { boxShadow: "0 0 40px hsl(var(--flow) / 0.6)" } },
